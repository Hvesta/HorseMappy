'use strict';
import {animerElement} from "../services/animation";
...
function ConnexionController() {
    ...
    const attacherElementsEtEvenementsModeConnexion = () => {
        ...
        const toggleScreenMode = () => {
            ...
            animerElement(elements.pointeur, 'bounceIn');
        };

        // Event handlers
        elements.btnMode.addEventListener('change', toggleScreenMode);
    }

    const attacherElementsEtEvenementsLogin = () => {
    ...
    this.afficherVue = function () {
        ...
        attacherElementsEtEvenementsLogin();
        animerElement(elements.titreAppli, 'bounceIn');
